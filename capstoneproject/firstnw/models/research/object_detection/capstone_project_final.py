...
PATH_TO_TEST_IMAGES_DIR = 'test_images' # 입력 이미지파일 저장경로 C:\Users\ldm81\PycharmProjects\capstoneproject\firstnw\models\research\object_detection\test_images
...
# C:\Users\ldm81\PycharmProjects\capstoneproject\firstnw\models\research\object_detection\resultimage\detection_image
...
def frame_offset_funtion(width, height, x, y, a, b, c, d, q, w, e, r):
    ...
    if frame_xmin >= x_min and frame_xmax <= x_max and frame_ymin >= y_min and frame_ymax <= y_max :
        return (q,e,w,r)
